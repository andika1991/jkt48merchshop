...
$query = "SELECT * FROM Pesanan WHERE id_pengguna = $id_pengguna AND status_pesanan = 'Menunggu Pembayaran'";
...
<h3 style="text-align:center;font-weight:bold; font-size:30px;padding:30px;">Pesanan Menunggu Pembayaran</h3>
...
<div class="order-list">
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    echo '<p>Tidak ada pesanan yang menunggu pembayaran.</p>';
                }
                ?>
