...
<div class="d-flex">
  ...
  <form method="POST" action="prosestambahpembayaran.php"  enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" id="petunjuk_pembayaran" name="petunjuk_pembayaran" rows="10" required></textarea>
    </div>
    <div class="form-group">
