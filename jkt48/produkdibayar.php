...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <main>
    <img src="asset/succesful.png" style="margin-left:550px; width:250px; height:250px; padding:15px; margin-top:30px;">
   <h2 style="text-align:center; font-weight:bold;">Horee...</h2>
   <h2 style="text-align:center; font-weight:bold;">Pembayaran Pesananmu Berhasil</h2>
