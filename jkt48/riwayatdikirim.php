...
$query = "SELECT * FROM Pesanan WHERE id_pengguna = '$id_pengguna' AND status_pesanan = 'Dikirim'";
...
<h3 style="text-align:center;font-weight:bold; font-size:30px;padding:30px;">Pesanan Dikirim</h3>
...
<div class="order-list">
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<a href="detailriwayatditerima.php?id_pengguna=' . $row['id_pengguna'] . 
                    ...
                    echo '<p>Tidak ada pesanan dikirim.</p>';
                }
                ?>
